...
import { ExternalLink, Search, Zap, Filter, ChevronDown, SortAsc, SortDesc, Clock, Target, TrendingUp, Star, ShoppingBag, CheckCircle } from "lucide-react";

export default function PersonalHuntPage() {
  ...
  async function secureForItem(id: string) {
    ...
    const { error } = await supabase
      .from('pulse_inventory')
      .update({ is_owned: true, status: 'available' })
      .eq('id', id);
