      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-20 md:gap-12 relative z-10">
        <div className="md:col-span-5">
          ...
          <div className="flex gap-6">
             <Link href="https://www.instagram.com/auvra.clothing/" target="_blank" rel="noopener noreferrer" className="p-4 bg-white border border-zinc-100 rounded-full hover:bg-black hover:text-white hover:scale-110 transition-all shadow-sm"><Instagram size={20} strokeWidth={1.5} /></Link>
