        ...
        <div className="max-w-7xl mx-auto px-6 h-16 md:h-24 flex items-center">
          ...
          <div className="flex-1 flex items-center">
            ...
            <nav className="hidden lg:flex items-center gap-12 text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500">
              ...
              {/* <Link href="/equipment" className="relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[1px] after:bg-black after:scale-x-0 hover:after:scale-x-100 after:origin-left after:transition-transform after:duration-300 hover:text-black transition-colors text-zinc-900">Tactical Gear</Link> */}
